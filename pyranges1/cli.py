...
def show_usage() -> None:
    """Display help/usage for the pyranges1 CLI."""
    prog = "pyranger"
    sys.stdout.write(
        f"""
pyranger: read sequence interval data into pyranges1 and apply a chain of methods
...
def main() -> None:  # noqa: C901,PLR0912,PLR0915
    """Entry point for the pyranges1 CLI."""
    if fire is None:
        sys.stderr.write(
