...
class PyRanges(RangeFrame):
    ...
    def extend_ranges(
        ...
        starts, ends = ruranges_py.extend(
    ...
    def split_overlaps(
        ...
        *,
        ...
        idxs, starts, ends = ruranges_py.split(
            groups=groups,
            starts=self[START_COL].to_numpy(),
            ends=self[END_COL].to_numpy(),
            slack=0,
    ...
    def tile_ranges(
        ...
        *,
        ...
        indices, starts, ends, overlap_fraction = ruranges_py.tile(  # type: ignore[attr-defined]
            starts=self[START_COL].to_numpy(),
            ends=self[END_COL].to_numpy(),
    ...
    def window_ranges(
        ...
        *,
        ...
        idx, starts, ends = ruranges_py.window(  # type: ignore[attr-defined]
            groups=group_ids,
    ...
    def group_cumsum(
        ...
        * ``cumsum_end_column``   - running total **after**  the interval
        ...
        """
        import ruranges_py  # local import reduces start-up time
        ...
        idx, cumsum_start, cumsum_end = ruranges_py.group_cumsum(  # type: ignore[attr-defined]
            starts=self[START_COL].to_numpy(),
            ends=self[END_COL].to_numpy(),
            groups=group_ids,
    ...
    def clip_ranges(
        ...
        *,
        ...
        idxs, starts, ends = ruranges_py.genome_bounds(
