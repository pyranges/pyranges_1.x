...
from pyranges.names import VALID_STRAND_TYPE, STRAND_AUTO, VALID_STRAND_BEHAVIOR_TYPE, VALID_STRAND_BEHAVIOR_OPTIONS, \
    STRAND_BEHAVIOR_OPPOSITE, STRAND_BEHAVIOR_AUTO, STRAND_BEHAVIOR_IGNORE, CHROM_COL, TEMP_STRAND_COL, STRAND_COL, \
    VALID_STRAND_OPTIONS, VALID_BY_OPTIONS

if TYPE_CHECKING:
    from pyranges import PyRanges


def validate_and_convert_strand(self, strand: VALID_STRAND_OPTIONS) -> bool:
...
def resolve_strand_argument_ensure_valid(self, strand: VALID_STRAND_TYPE, ) -> bool:
...
def ensure_strand_behavior_options_valid(
    self: "pr.PyRanges", other: "pr.PyRanges", strand_behavior: VALID_STRAND_BEHAVIOR_TYPE,
) -> None:
