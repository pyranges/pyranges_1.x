...
class PyRanges(pr.RangeFrame):
    ...
    def get_with_loc_columns(
        ...
        >>> gr2 = pr.data.ensembl_gtf()
        >>> cols = list(gr2.columns)[:10]
        >>> cols
        ['Chromosome', 'Source', 'Feature', 'Start', 'End', 'Score', 'Strand', 'Frame', 'gene_biotype', 'gene_id']

        >>> gr2.get_with_loc_columns(["Frame", "Feature", "gene_id"])  # moves loc columns to the left by default
        Chromosome    Start    End      Strand      Frame     Feature     gene_id
        category      int64    int64    category    object    category    object
        ------------  -------  -------  ----------  --------  ----------  ---------------
        ...
        ...           ...      ...      ...         ...       ...         ...
        1             1173055  1179555  -           .         gene        ENSG00000205231
        1             1173055  1179555  -           .         transcript  ENSG00000205231
        1             1179364  1179555  -           .         exon        ENSG00000205231
        1             1173055  1176396  -           .         exon        ENSG00000205231
        PyRanges with 2446 rows and 7 columns.
        Contains 1 chromosomes and 2 strands.

        >>> # loc column order preserved, key order respected
        >>> gr2.get_with_loc_columns(["Frame", "Feature", "gene_id"], preserve_loc_order=True)
        Chromosome    Frame     Start    End      Strand      Feature     gene_id
        category      object    int64    int64    category    category    object
        ------------  --------  -------  -------  ----------  ----------  ---------------
        1             .         11868    14409    +           gene        ENSG00000223972
        1             .         11868    14409    +           transcript  ENSG00000223972
        1             .         11868    12227    +           exon        ENSG00000223972
        ...
        >>> gr2.get_with_loc_columns(["gene_id", "Feature", "gene_id"], preserve_loc_order=True)
        Traceback (most recent call last):
        ...
